...
if (WebUI.verifyElementPresent(findTestObject('0.Study/RecordOnExistingBrowser/testnets.opensea.io/my_wallet_text'), 5, FailureHandling.OPTIONAL)) {
...
//neu chua login metamask thi se thay bieu tuong metamask xuat hien
if (WebUI.verifyElementPresent(findTestObject('0.Study/RecordOnExistingBrowser/testnets.opensea.io/account_circle'), 5, FailureHandling.OPTIONAL)) {
...
WebUI.uploadFile(findTestObject('Object Repository/0.Study/RecordOnExistingBrowser/testnets.opensea.io/featured_image'), fileToUpload2)
...
WebUI.setText(findTestObject('0.Study/RecordOnExistingBrowser/testnets.opensea.io/name_field'),
	'manh3')
WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/0.Study/RecordOnExistingBrowser/testnets.opensea.io/button_Create'))
WebUI.delay(3)

//WebUI.click(findTestObject('0.Study/RecordOnExistingBrowser/Page_The Internet/file_submit'))

/*
def filePath = RunConfiguration.getProjectDir() + '/imageToUpload/test1.png'

WebUI.waitForElementVisible(findTestObject('Object Repository/0.Study/RecordOnExistingBrowser/testnets.opensea.io/logo_image'), 5)
//Upload test-photo.png to input_browse's
WebUI.uploadFile(findTestObject('Object Repository/0.Study/RecordOnExistingBrowser/testnets.opensea.io/logo_image'), 'C:/Users/LAP15239-local/Katalon Studio/git/katalon/imageToUpload/test1.png')

//WebUI.click(findTestObject('Object Repository/0.Study/RecordOnExistingBrowser/testnets.opensea.io/logo_image'))
//
//WebUI.click(findTestObject('Object Repository/0.Study/RecordOnExistingBrowser/testnets.opensea.io/featured_image'))
//
//WebUI.click(findTestObject('Object Repository/0.Study/RecordOnExistingBrowser/testnets.opensea.io/banner_image'))
