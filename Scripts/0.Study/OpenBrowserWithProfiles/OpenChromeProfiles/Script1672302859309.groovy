...
if (WebUI.verifyElementPresent(findTestObject('0.Study/RecordOnExistingBrowser/testnets.opensea.io/my_wallet_text'), 5, FailureHandling.OPTIONAL)) {
    ...
    //    WebUI.delay(3)
    WebUI.sendKeys(findTestObject('0.Study/RecordOnExistingBrowser/Page_Chainlist/Password_textbox'), Keys.chord(Keys.CONTROL, 'a'))
...
WebUI.setText(findTestObject('0.Study/RecordOnExistingBrowser/testnets.opensea.io/name_field'), 'manh3')
