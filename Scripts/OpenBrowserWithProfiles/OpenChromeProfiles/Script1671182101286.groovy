...
WebUI.waitForElementVisible(findTestObject('RecordOnExistingBrowser/testnets.opensea.io/wallet_icon'), 5)
...
if (WebUI.verifyElementPresent(findTestObject('RecordOnExistingBrowser/testnets.opensea.io/my_wallet_text'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.setText(findTestObject('RecordOnExistingBrowser/Page_Chainlist/Password_textbox'), password_wrong)

    WebUI.click(findTestObject('RecordOnExistingBrowser/Page_Chainlist/Unlock_btn'))

    //    WebUI.delay(3)
    WebUI.sendKeys(findTestObject('RecordOnExistingBrowser/Page_Chainlist/Password_textbox'), Keys.chord(Keys.CONTROL, 'a'))

    WebUI.sendKeys(findTestObject('RecordOnExistingBrowser/Page_Chainlist/Password_textbox'), Keys.chord(Keys.BACK_SPACE))
...
WebUI.setText(findTestObject('RecordOnExistingBrowser/testnets.opensea.io/name_field'), 'manh3')
