...
WebUI.switchToFrame(findTestObject('RecordOnExistingBrowser/Selenium/iframe'), 3)

WebUI.delay(3)

WebUI.click(findTestObject('RecordOnExistingBrowser/Selenium/selenium_packages_1'))
