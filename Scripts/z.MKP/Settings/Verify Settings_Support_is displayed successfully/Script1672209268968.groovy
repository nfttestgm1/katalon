...
WebUI.click(findTestObject('Object Repository/1.MKP/Settings/p_Support'))

WebUI.verifyElementVisible(findTestObject('Object Repository/1.MKP/Settings/div_Support Center'))
