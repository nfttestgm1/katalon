...
WebUI.click(findTestObject('Object Repository/1.MKP/Settings/p_Notifications'))

WebUI.verifyElementVisible(findTestObject('Object Repository/1.MKP/Settings/div_Notification Settings'))

WebUI.verifyElementVisible(findTestObject('Object Repository/1.MKP/Settings/button_Save'))
